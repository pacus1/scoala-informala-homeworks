...
public class VWGolf extends VW {
	...
	double[] gearSpecificConsumption = new double[] {0.4,15,12,9,7,4};//consumption in liter/100km; [0] is hourly consumption engine idle
	...
	public VWGolf(String brandName, String model, String chassisNo, int productionYear, FuelType fuelType,
			float carPrice) {
